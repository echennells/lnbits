...
import lnbits.wallets.tapd_grpc_files.rfqrpc.rfq_pb2 as rfqrpc_dot_rfq__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in rfqrpc/rfq_pb2_grpc.py depends on'
...
class RfqStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddAssetBuyOrder = channel.unary_unary(
                ...
                request_serializer=rfqrpc_dot_rfq__pb2.AddAssetBuyOrderRequest.SerializeToString,
                response_deserializer=rfqrpc_dot_rfq__pb2.AddAssetBuyOrderResponse.FromString,
                _registered_method=True)
        self.AddAssetSellOrder = channel.unary_unary(
                '/rfqrpc.Rfq/AddAssetSellOrder',
                request_serializer=rfqrpc_dot_rfq__pb2.AddAssetSellOrderRequest.SerializeToString,
                response_deserializer=rfqrpc_dot_rfq__pb2.AddAssetSellOrderResponse.FromString,
                _registered_method=True)
        self.AddAssetSellOffer = channel.unary_unary(
                '/rfqrpc.Rfq/AddAssetSellOffer',
                request_serializer=rfqrpc_dot_rfq__pb2.AddAssetSellOfferRequest.SerializeToString,
                response_deserializer=rfqrpc_dot_rfq__pb2.AddAssetSellOfferResponse.FromString,
                _registered_method=True)
        self.AddAssetBuyOffer = channel.unary_unary(
                '/rfqrpc.Rfq/AddAssetBuyOffer',
                request_serializer=rfqrpc_dot_rfq__pb2.AddAssetBuyOfferRequest.SerializeToString,
                response_deserializer=rfqrpc_dot_rfq__pb2.AddAssetBuyOfferResponse.FromString,
                _registered_method=True)
        self.QueryPeerAcceptedQuotes = channel.unary_unary(
                '/rfqrpc.Rfq/QueryPeerAcceptedQuotes',
                request_serializer=rfqrpc_dot_rfq__pb2.QueryPeerAcceptedQuotesRequest.SerializeToString,
                response_deserializer=rfqrpc_dot_rfq__pb2.QueryPeerAcceptedQuotesResponse.FromString,
                _registered_method=True)
        self.SubscribeRfqEventNtfns = channel.unary_stream(
                '/rfqrpc.Rfq/SubscribeRfqEventNtfns',
                request_serializer=rfqrpc_dot_rfq__pb2.SubscribeRfqEventNtfnsRequest.SerializeToString,
                response_deserializer=rfqrpc_dot_rfq__pb2.RfqEvent.FromString,
                _registered_method=True)
...
def add_RfqServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddAssetBuyOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=rfqrpc_dot_rfq__pb2.AddAssetBuyOrderRequest.FromString,
                    response_serializer=rfqrpc_dot_rfq__pb2.AddAssetBuyOrderResponse.SerializeToString,
            ),
            'AddAssetSellOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.AddAssetSellOrder,
                    request_deserializer=rfqrpc_dot_rfq__pb2.AddAssetSellOrderRequest.FromString,
                    response_serializer=rfqrpc_dot_rfq__pb2.AddAssetSellOrderResponse.SerializeToString,
            ),
            'AddAssetSellOffer': grpc.unary_unary_rpc_method_handler(
                    servicer.AddAssetSellOffer,
                    request_deserializer=rfqrpc_dot_rfq__pb2.AddAssetSellOfferRequest.FromString,
                    response_serializer=rfqrpc_dot_rfq__pb2.AddAssetSellOfferResponse.SerializeToString,
            ),
            'AddAssetBuyOffer': grpc.unary_unary_rpc_method_handler(
                    servicer.AddAssetBuyOffer,
                    request_deserializer=rfqrpc_dot_rfq__pb2.AddAssetBuyOfferRequest.FromString,
                    response_serializer=rfqrpc_dot_rfq__pb2.AddAssetBuyOfferResponse.SerializeToString,
            ),
            'QueryPeerAcceptedQuotes': grpc.unary_unary_rpc_method_handler(
                    servicer.QueryPeerAcceptedQuotes,
                    request_deserializer=rfqrpc_dot_rfq__pb2.QueryPeerAcceptedQuotesRequest.FromString,
                    response_serializer=rfqrpc_dot_rfq__pb2.QueryPeerAcceptedQuotesResponse.SerializeToString,
            ),
            'SubscribeRfqEventNtfns': grpc.unary_stream_rpc_method_handler(
                    servicer.SubscribeRfqEventNtfns,
                    request_deserializer=rfqrpc_dot_rfq__pb2.SubscribeRfqEventNtfnsRequest.FromString,
                    response_serializer=rfqrpc_dot_rfq__pb2.RfqEvent.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'rfqrpc.Rfq', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('rfqrpc.Rfq', rpc_method_handlers)
...
class Rfq(object):
    ...
    def AddAssetBuyOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rfqrpc.Rfq/AddAssetBuyOrder',
            rfqrpc_dot_rfq__pb2.AddAssetBuyOrderRequest.SerializeToString,
            rfqrpc_dot_rfq__pb2.AddAssetBuyOrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def AddAssetSellOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rfqrpc.Rfq/AddAssetSellOrder',
            rfqrpc_dot_rfq__pb2.AddAssetSellOrderRequest.SerializeToString,
            rfqrpc_dot_rfq__pb2.AddAssetSellOrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def AddAssetSellOffer(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rfqrpc.Rfq/AddAssetSellOffer',
            rfqrpc_dot_rfq__pb2.AddAssetSellOfferRequest.SerializeToString,
            rfqrpc_dot_rfq__pb2.AddAssetSellOfferResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def AddAssetBuyOffer(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rfqrpc.Rfq/AddAssetBuyOffer',
            rfqrpc_dot_rfq__pb2.AddAssetBuyOfferRequest.SerializeToString,
            rfqrpc_dot_rfq__pb2.AddAssetBuyOfferResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def QueryPeerAcceptedQuotes(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rfqrpc.Rfq/QueryPeerAcceptedQuotes',
            rfqrpc_dot_rfq__pb2.QueryPeerAcceptedQuotesRequest.SerializeToString,
            rfqrpc_dot_rfq__pb2.QueryPeerAcceptedQuotesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SubscribeRfqEventNtfns(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/rfqrpc.Rfq/SubscribeRfqEventNtfns',
            rfqrpc_dot_rfq__pb2.SubscribeRfqEventNtfnsRequest.SerializeToString,
            rfqrpc_dot_rfq__pb2.RfqEvent.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
